...
[![Version 10.0.0](https://img.shields.io/badge/version-10.0.0-lightgrey.svg)](https://github.com/fruiting/gogen-avro/releases)
...
```
go install github.com/fruiting/gogen-avro/v10/cmd/...@latest
```
...
```
import "github.com/fruiting/gogen-avro/v10/generic"
...
You can also use a `go:generate` directive in a source file ([example](https://github.com/fruiting/gogen-avro/blob/master/v10/test/primitive/generate.go#L3)):
...
An example of how to write a container file can be found in [example/container/example.go](https://github.com/fruiting/gogen-avro/blob/master/v10/example/container/example.go).

[Godocs for the container package](https://godoc.org/github.com/fruiting/gogen-avro/v10/container)

### Single-Object Encoding

An example of how to read and write Single-Object encoded messages (for use with Kafka, for instance) can be found in [example/single_object/example.go](https://github.com/fruiting/gogen-avro/blob/master/v10/example/single_object/example.go).

[Godocs for the soe package](https://godoc.org/github.com/fruiting/gogen-avro/v10/soe)
...
go generate github.com/fruiting/gogen-avro/v10/example

# Install the example projects on the GOPATH
go install github.com/fruiting/gogen-avro/v10/example/record
go install github.com/fruiting/gogen-avro/v10/example/container
```
...
As of v7, this project uses go modules. Imports should be written as `github.com/fruiting/gogen-avro/v7`. Generated code will reference the same major version as the CLI tool.
...
See [Releases](https://github.com/fruiting/gogen-avro/releases) for the changelogs.
